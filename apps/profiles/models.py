...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+263717200738")
    ...
    country = CountryField(verbose_name=(_("Country")), default="ZW", blank=False, null=False)
